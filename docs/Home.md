...
- [New-Feature](New-Feature.md) – Från idé till produktion
- [Bug-Investigation](Bug-Investigation.md) – Systematisk felsökning med agent
- [Code-Review-With-Agent](Code-Review-With-Agent.md) – Effektiv kodgranskning
- [Refactoring-Safely](Refactoring-Safely.md) – Stora ändringar utan att bryta saker
- [Legacy-Codebase-Onboarding](Legacy-Codebase-Onboarding.md) – Snabb orientering i ny kodbas

## Samarbete

- [Developer-Agent-Dynamics](Developer-Agent-Dynamics.md) – Vem gör vad?
- [Pair-Programming-Mode](Pair-Programming-Mode.md) – Interaktivt samarbete
- [Delegation-Mode](Delegation-Mode.md) – Låt agenten jobba självständigt
- [Review-Mode](Review-Mode.md) – Granska agentens arbete
...
- [Greenfield-Lovable-Fullstack](Greenfield-Lovable-Fullstack.md) – Frontend i Lovable, backend med Claude Code

---

## Relaterade resurser

- [claude-code](https://github.com/Wizardworks-AB/claude-code) – Teknisk setup
- [patterns-and-practices](https://github.com/Wizardworks-AB/wizardworks-patterns-and-practices) – Kodstandarder
